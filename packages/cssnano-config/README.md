## @davidsneighbour/cssnano-config

[CSSnano](https://cssnano.co/) configuration for [davidsneighbour](https://github.com/davidsneighbour/) projects.
...
```shell
npm install --save-dev @davidsneighbour/cssnano-config
```
...
```js
const preset = require("@davidsneighbour/cssnano-config");
