...
Adds all dnb-org configuration packages to a package setup. You probably won't need this package. Don't install any of the other packages to avoid versioning issues.
...
```shell
npm install --save-dev @dnb-org/all
```

### Configuration

To find out more about configuring individual packages please check their respective README.md files.
