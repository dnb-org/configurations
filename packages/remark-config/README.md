...
[Remark](https://github.com/remarkjs/remark-lint) configuration used in [davidsneighbour](https://github.com/davidsneighbour) projects.
...
```shell
npm install --save-dev @davidsneighbour/remark-config
```
